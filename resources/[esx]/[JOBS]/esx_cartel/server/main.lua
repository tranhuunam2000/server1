...
AddEventHandler('esx_cartel:buyItem', function()
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_cartel', function(inventory)
		...
		if account.money >= 5000 then
		  ...
		  TriggerClientEvent('esx:showNotification', source, 'Ban da mua 1 chiec may khoan voi gia 5000')
		  
		  inventory.addItem('drill', 1)
		  account.removeMoney(5000)
		  
		else
		  TriggerClientEvent('esx:showNotification', source, 'Khong duoc phep')
		end
